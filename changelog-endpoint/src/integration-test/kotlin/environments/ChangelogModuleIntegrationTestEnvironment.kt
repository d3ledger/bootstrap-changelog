...
//Here lies the notary expansion changelog script
private const val NOTARY_EXPANSION_CHANGELOG_PATH = "samples/notary_expansion_changelog.groovy"
//Script file generated by the test
private const val TEST_CHANGELOG_PATH = "samples/test_changelog.groovy"
...
class ChangelogModuleIntegrationTestEnvironment : Closeable {
     ...
     */
    fun createChangelogFileRequest(accountName: String): ChangelogFileRequest {
    ...
    /**
     * Creates notary expansion changelog request
     */
    fun createNotaryExpansionChangelogRequest(): ChangelogFileRequest {
        return ChangelogFileRequest(
            changelogFile = NOTARY_EXPANSION_CHANGELOG_PATH,
            details = ChangelogRequestDetails(
                accounts = listOf(
                    ChangelogAccountPublicInfo(
                        2,
     ...
     * @param schemaVersion - version of changelog schema
     */
    fun createAccountScriptFile(accountName: String, schemaVersion: String) {
